...
const FormFireArms = ({ currentWeapon, handleClose, userId }) => {
  ...
  const UserAddressSchema = Yup.object().shape({
    ...
    origin: Yup.string().required("Selecione a orgiem da arma"),
...
FormFireArms.propTypes = {
  currentWeapon: PropTypes.object,
  handleClose: PropTypes.func,
};

export default FormFireArms;
